...
/**
 * Tests the JML specifications of the {@link SmallIdentityHashMapForBugInPut#put(Object, Object)}
 * method in relation to a possible bug.
 */
public class SmallIdentityHashMapBugInPutTest {

    private SmallIdentityHashMapForBugInPut<Object, Object> map;
    ...
    private void initAndBreakInvariant()
            throws NoSuchFieldException, IllegalAccessException, NoSuchClassException {
        final int maxCapacity = (int) getValueByStaticFieldName(SmallIdentityHashMapForBugInPut.class, "MAXIMUM_CAPACITY");
        map = new SmallIdentityHashMapForBugInPut<Object, Object>();
    ...
    private void printState(SmallIdentityHashMapForBugInPut<Object, Object> map)
            throws NoSuchFieldException, IllegalAccessException, NoSuchClassException {
        final int maxCapacity = (int) getValueByStaticFieldName(SmallIdentityHashMapForBugInPut.class, "MAXIMUM_CAPACITY");
    ...
    private void printViolatedInvariantClauses(SmallIdentityHashMapForBugInPut<Object, Object> map, Object[] table)
            throws NoSuchFieldException, IllegalAccessException {
        final int maxCapacity = (int) getValueByStaticFieldName(SmallIdentityHashMapForBugInPut.class, "MAXIMUM_CAPACITY");
        final int minCapacity = (int) getValueByStaticFieldName(SmallIdentityHashMapForBugInPut.class, "MINIMUM_CAPACITY");
        final int threshold = (int) getValueByFieldName(map, "threshold");
